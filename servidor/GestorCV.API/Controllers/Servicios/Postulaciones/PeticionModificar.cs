...
namespace GestorCV.API.Controllers.Servicios.Postulaciones
{
    public class PeticionModificar: PeticionBase
    {
        ...
        private void EnviarCorreoUsuario(RepositorioPostulaciones.RespuestaModificarPostulacion respuestaModificarPostulacion, string nuevoEstado)
        {
            ...
            {
                case "Revisado":
                    mensajeNotificacion = $"El equipo técnico del empleo '{respuestaModificarPostulacion.TituloEmpleo}' se encuentra revisando su candidatura. En breve la organización le notificará los resultados. <br /><br />Muchas Gracias";
                    break;
                case "Descartado":
                    mensajeNotificacion = $"Lamentamos informarle que el equipo técnico del empleo '{respuestaModificarPostulacion.TituloEmpleo}' ha decidido descartar su candidatura. <br />De todas formas, no te aflijas y no dejes de intentarlo. Confía siempre en tí mismo. <br /><br />Muchas Gracias";
                    break;
                case "Entrevista":
                    mensajeNotificacion = $"El equipo técnico del empleo '{respuestaModificarPostulacion.TituloEmpleo}' ha decidido continuar con las entrevistas. En breve, algún miembro de la organización se pondrá en contacto con usted para proceder. <br /><br />¡Mucha Suerte!";
                    break;
                case "Finalizado":
                    mensajeNotificacion = $" ¡Felicitaciones! El equipo técnico del empleo '{respuestaModificarPostulacion.TituloEmpleo}' ha aprobado su entrevista. <br /><br />¡Mucha Suerte en esta nueva etapa!";
                    break;
            }
            ...
            ServicioCorreo.Instancia.EnviarCorreo(
                ...
                $"{respuestaModificarPostulacion.UsuarioNombre} - Nuevo estado del empleo '{respuestaModificarPostulacion.TituloEmpleo}'",
                $"Estimad@ {respuestaModificarPostulacion.UsuarioNombre},<br /><br />{mensajeNotificacion}");
        }
        ...
        {
            var mensaje = $"Su postulación a '{respuestaModificarPostulacion.TituloEmpleo}' ha pasado a estado '{estado}'.";
